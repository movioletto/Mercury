  ...
  <div class="panel-body">
      <center>
        ...
        <table cellpadding="10px">
            <ul class="list-group">
                <li style="list-style-type: none;"><button type="button" class="list-group-item"><a href="./gestioneEnti.jsp">Gestione enti</a></button></li><br>
                <li style="list-style-type: none;"><button type="button" class="list-group-item"><a href="./gestioneEventi.jsp">Gestione eventi</a></button></li><br>
