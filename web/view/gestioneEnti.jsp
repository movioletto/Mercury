                    ...
                    <center>
                        ...
                        <table cellpadding="10px">
                            <form>
                                ...
                                <% if (ente.get(i).getAttivo() == 0) {%><li style="background-color: #de9e9e;" class="list-group-item list-group-item-danger"><%= ente.get(i).getUser()%><a href="?id=<%= ente.get(i).getId()%>&trash-user=y" style="float: right; font-size: 21px;" class="fa fa-trash" aria-hidden="true"></a>  <a href="?id=<%= ente.get(i).getId()%>&status-user=on" style="float: right; font-size: 21px; margin-right: 10px;" class="fa fa-toggle-off" aria-hidden="true"></a><% } else {%>
                                <li class="list-group-item"><%= ente.get(i).getUser()%><a href="?id=<%= ente.get(i).getId()%>&trash-user=y" style="float: right; font-size: 21px;" class="fa fa-trash" aria-hidden="true"></a> <a href="?id=<%= ente.get(i).getId()%>&status-user=off" style="float: right; font-size: 21px; margin-right: 10px;" class="fa fa-toggle-on" aria-hidden="true"></a></li>
                                    <% }
                                    }%>
                            </ul>
                        </form>
